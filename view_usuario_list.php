...
<div id='listagem'>
	<div class="block">
					...
					<form accept-charset="utf-8" action="controller_<?php  echo $controllernome; ?>.php" method="post" enctype="multipart/form-data" id="facilidade" onsubmit="return false;">
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							?>
								...
								?>
									<td class="acoes"><a href="javascript:exclui('<?php echo $idchave; ?>', '<?php echo $resultados[$displaydel[0]]; ?>','#del<?php echo $idchave; ?>');" title="Excluir" id='del<?php echo $idchave; ?>' class='lixo'></a></td>
							...
							?>
								...
								foreach($campos as $titulo=>$campo){
									$somatorio = 0.0;
									if(!empty($campoautosomar[$titulo])){
		...
		<div class="pagination right">
			...
			?>
			<input type="text" name="pagina" size="3" value="<?php echo $pagina; ?>"><input type="hidden" name="i" value="<?php echo $_GET['i']; ?>"><input type="hidden" name="acao" value="list"></form>
		</div>		<!-- .pagination ends -->
